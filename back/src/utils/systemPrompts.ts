...
- Give all answers using Markdown format, including tables.
...
- Do not rely solely on conversation history to answer questions. 
  If the relevant data is available via tool calls, always use the tools to fetch up-to-date information.
